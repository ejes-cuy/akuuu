...
class Lelang_model extends CI_Model
{
    ...
    public function get_pemenangLelangDash() //menampilkan list unconfirmed pemenang lelang di dashboard  
    {
    ...
    public function get_pemenang($id_masyarakat) //menampilkan pemenang 
    {
    ...
    public function get_by_id($id_lelang) //comfirm pememang
    {
        $query = $this->db->get_where($this->_table, array('id_lelang' => $id_lelang));
        return $query;
    }

    public function berlangsung_by_id($id_lelang) //detail lelang
    {
