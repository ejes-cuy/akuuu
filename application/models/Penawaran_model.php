...
{ 
    ...
    public function get_by_penawar($id_masyarakat) //menampilkan riwayat penawar
    {
    ...
    public function get_by_lelang($id_lelang) //mengclose lelang
    {
    ...
    public function get_tawar_lelang($id_lelang) //detail lelang
    {
    ...
    public function insert($data)  //kirim penawaran
    {
    ...
    public function get_by_id($id_penawaran) //hapus penawaran
    {
        $query = $this->db->get_where($this->_view, array('id_penawaran' => $id_penawaran));
        return $query;
    }

    public function delete($id) //hapus penawaran
    {
        if (!$id) {
            return;
        }
