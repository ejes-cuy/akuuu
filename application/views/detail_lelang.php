...
<body>
    ...
    <div class="content">
        <div class="container my-4 col-8">
            <div >
                <h5 class="text-center"><b><?= $lelang->nama_barang ?></b></h5>
            </div>
            <hr>
            <div class="container row">
                <div class="col-5">
                    <div id="carouselExampleIndicators" class="carousel slide card" style="height: auto; width: 300px;" data-bs-ride="carousel">
            ...
            <hr>
            <div class="bg-secondary px-4 py-2 text-white" style="width: 1000px;">
